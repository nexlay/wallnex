...
const profileRive = 'assets/rive/profile.riv';
...
const logo = 'assets/rive/wallnex_logo.riv';
const lock = 'assets/rive/lock.riv';
const done = 'assets/rive/done.riv';
//Add assets into list
const navBarAssetList = [home, favorite, profileRive];